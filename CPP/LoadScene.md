...
- shared_ptr<[Scene](Scene.md)> **LoadScene**(shared_ptr<[World](World.md)> world, shared_ptr<[Stream](Stream.md)> stream, const LoadFlags flags = LOAD_DEFAULT, shared_ptr<[Object](Object.md)> extra = NULL)
