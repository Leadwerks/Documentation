...
- void **SetSsr**(const bool mode, const float scale = 0.5, const float stepsize = 0.01, const float stepdelta = 1.1, const int maxsteps = 100, const bool reflecttransparency = false)
