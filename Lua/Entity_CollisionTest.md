...
- [Collision](Collision.md)[] **CollisionTest**([Entity](Entity.md) entity, number hits = 1)
- [Collision](Collision.md)[] **CollisionTest**(number hits = 1)
- [Collision](Collision.md)[] **CollisionTest**([Vec3](Vec3.md) position, [Quat](Quat.md) rotation, number hits = 1)
