...
| kids | [Entity](Entity.md)[] | read-only array of child entities |
...
| [CollisionTest](Entity_CollisionTest.md) | Method | performs a static or swept collision test |
...
| [SetPlayerSize](Entity_SetPlayerSize.md) | Method | sets the entity size for player physics |
