...
The [script editor](scripteditor.md) will open any time you double-click on a code file in the [project panel](assetbrowser.md), or you can select the **Scripting > Script Editor** item in the main menu.
